...
Future<void> fetchProfiles() async {
  try {
    ...
    final response = await http.get(
      Uri.parse('https://6762a6b5-bcae-47d9-9b32-173db9699b2c-00-2yzwy4xs0f5zs.pike.replit.dev/requested-profiles?handymanId=$_id'),
    );
...
class _ProfileDetailPageState extends State<ProfileDetailPage> {
  ...
  Future<void> acceptBooking(BuildContext context) async {
    ...
    final response = await http.post(
      Uri.parse('https://6762a6b5-bcae-47d9-9b32-173db9699b2c-00-2yzwy4xs0f5zs.pike.replit.dev/accept-booking'),
  ...
  Future<void> declineBooking(BuildContext context) async {
    ...
    final response = await http.post(
      Uri.parse('https://6762a6b5-bcae-47d9-9b32-173db9699b2c-00-2yzwy4xs0f5zs.pike.replit.dev/decline-booking'),
      headers: {'Content-Type': 'application/json'},
      body: jsonEncode({
        'bookingId': widget.bookingId,
        'handymanId': widget.handymanId,
...
class _BookingListScreenState extends State<BookingListScreen> {
  ...
  Future<List<Booking>> _fetchBookings() async {
    try {
      final response = await http.get(
        Uri.parse('https://6762a6b5-bcae-47d9-9b32-173db9699b2c-00-2yzwy4xs0f5zs.pike.replit.dev/bookings?handymanId=${widget.handyManId}&status=${widget.status}'),
      );
      if (response.statusCode == 200) {
  ...
  Future<void> _reportBooking(String bookingId, String reportReason) async {
    try {
      final response = await http.post(
        Uri.parse('https://6762a6b5-bcae-47d9-9b32-173db9699b2c-00-2yzwy4xs0f5zs.pike.replit.dev/reports'),
        headers: {'Content-Type': 'application/json'},
  ...
  Future<void> _markAsCompleted(String bookingId) async {
    try {
      final response = await http.patch(
        Uri.parse('https://6762a6b5-bcae-47d9-9b32-173db9699b2c-00-2yzwy4xs0f5zs.pike.replit.dev/bookings/$bookingId/complete'),
        headers: {'Content-Type': 'application/json'},
      );
      if (response.statusCode == 200) {
  ...
  Future<void> _submitFeedback(String bookingId, int rating, String feedback) async {
    try {
      final response = await http.post(
        Uri.parse('https://6762a6b5-bcae-47d9-9b32-173db9699b2c-00-2yzwy4xs0f5zs.pike.replit.dev/feedback'),
        headers: {'Content-Type': 'application/json'},
        body: json.encode({
          'bookingId': bookingId,
          'rating': rating,
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      var response = await http.post(
        Uri.parse('https://6762a6b5-bcae-47d9-9b32-173db9699b2c-00-2yzwy4xs0f5zs.pike.replit.dev/contact-admin'), // Change to your server address
        headers: {
